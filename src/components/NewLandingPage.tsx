      ...
      <nav>
        ...
        <div className="nav-right">
          <button className="theme-toggle" id="themeToggle" title="Toggle light/dark" onClick={toggleTheme}>
            <span className="toggle-icon-light"></span>
        ...
        <div className="hero-inner">
          <div className="hero-left">
            ...
            <h1 className="hero-title">
              <span className="line">
                <span style={{ display: 'inline-flex', alignItems: 'center', minHeight: '1.15em' }}>
                  <span className="hl-accent" style={{ minWidth: '2ch' }}>{displayed}</span>
